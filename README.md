...
Проект представляет собой распределённую систему оформления заказов, реализованную на основе микросервисной архитектуры с использованием шаблонов Saga и Outbox Pattern.
...
- Shared библиотеки — общие контракты, Outbox и метрики
